...
class DescribeTagsApiRequestSchema(Schema):
    ...
    resource_type_N = fields.List(
        fields.String(example="", validate=OneOf(__SRV_AWS_TAGS_RESOURCE_TYPE__)),
        required=False,
        allow_none=True,
        context="query",
...
class DescribeTags(ServiceApiView):
    ...
    def get(self, controller, data, *args, **kwargs):
        ...
        tags, tot = controller.get_service_tags_with_instance(
            value_list=tag_values,
    ...
    def validate_unsupported_parameters(self, data, *args, **kvargs):
        ...
        if "Value" in keys:
            raise ValidationError(
                "Parameters Tag.N.Value is not supported. Can be used only the parameter " "Parameters Tag.N.Key"
            )
...
class CreateTags(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": CreateTagsApiResponseSchema}})
    ...
    def post(self, controller, data, *args, **kwargs):
        ...
        service_list, toto = controller.get_paginated_service_instances(
            service_uuid_list=service_ids,
...
class DeleteTags(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": DeleteTagsResponseSchema}})
    ...
    def delete(self, controller, data, *args, **kwargs):
        ...
        service_ids = data.get("ResourceId_N", [])
        service_list, toto = controller.get_paginated_service_instances(
            service_uuid_list=service_ids, details=False, size=-1, filter_expired=False
        )
