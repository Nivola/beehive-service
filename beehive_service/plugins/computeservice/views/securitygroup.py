...
class ComputeSecurityGroupAPI(ApiView):
    ...
    def register_api(module, dummyrules=None, **kwargs):
        ...
        rules = [
            (
                "%s/computeservices/securitygroup/deletesecuritygroup" % base,
                "DELETE",
                DeleteSecurityGroup10,
                {},
            ),
            (
                "%s/computeservices/securitygroup/createsecuritygroup" % base,
                "POST",
                CreateSecurityGroup10,
                {},
            ),
            (
                "%s/computeservices/securitygroup/patchsecuritygroup" % base,
                "PATCH",
                PatchSecurityGroup10,
                {},
            ),
            (
                "%s/computeservices/securitygroup/describesecuritygroups" % base,
                "GET",
                DescribeSecurityGroups10,
                {},
            ),
            (
                "%s/computeservices/securitygroup/authorizesecuritygroupingress" % base,
                "POST",
                AuthorizeSecurityGroupIngress10,
                {},
            ),
            (
                "%s/computeservices/securitygroup/authorizesecuritygroupegress" % base,
                "POST",
                AuthorizeSecurityGroupEgress10,
                {},
            ),
            (
                "%s/computeservices/securitygroup/revokesecuritygroupingress" % base,
                "DELETE",
                RevokeSecurityGroupIngress10,
                {},
            ),
            (
                "%s/computeservices/securitygroup/revokesecuritygroupegress" % base,
                "DELETE",
