...
from beehive_service.plugins.computeservice.controller import ApiComputeImage, ApiComputeService
...
class ImageBlockDeviceMappingItem1ResponseSchema(Schema):
    deleteOnTermination = fields.Boolean(required=False,  allow_none=True, description='boolean to know if the volume is deleted '
...
class ImageBlockDeviceMappingResponseSchema(Schema):
    ...
    noDevice = fields.List(fields.String(), required=False, description='suppresses the specified device included '
...
class ImageItemParameterResponseSchema(Schema):
    ...
    imageId = fields.String(
        required=False,
        allow_none=True, example='',
        description='image instance id')
    imageLocation = fields.String(
        required=False,
        allow_none=True, example='',
    ...
    imageState = fields.String(
        ...
        validate=OneOf([getattr(ApiComputeImage.state_enum, x) for x in dir(ApiComputeImage.state_enum) if not x.startswith("__")]))
    ...
    sriovNetSupport = fields.String(
        ...
        allow_none=True,
        example='',
        description='indicates whether the Intel 82599 Virtual enhanced networking is '
        'enabled')
    ...
    nvl_minDiskSize = fields.Integer(
        required=False,
        allow_none=True,
        description='minimum image disk size', data_key='nvl-minDiskSize')
...
class DescribeImagesResponse1Schema(Schema):
    ...
    nvl_imageTotal = fields.Integer(required=False, example='', description='total number of items', data_key='nvl-imageTotal')
...
class DescribeImagesRequestSchema(Schema):
    ...
    imageId_N = fields.List(
        ...
        context='query',
        collection_format='multi',
        data_key='ImageId.N', description
        ='image id')
    ...
    state_N = fields.List(
        fields.String(
            example='',
            validate=OneOf(['pending', 'available', 'failed'])),
        required=False,
        allow_none=True,
        context='query',
        collection_format='multi',
...
class DescribeImages(ServiceApiView):
    ...
    tags = ['computeservice']
    definitions = {
        'DescribeImagesResponseSchema': DescribeImagesResponseSchema
    }
    ...
    responses = ServiceApiView.setResponses({
        200: {
            'description': 'success',
            'schema': DescribeImagesResponseSchema
        }
    })
...
class CreateImage(ServiceApiView):
    ...
    responses = ServiceApiView.setResponses({
        202: {
            'description': 'success',
            'schema': CreateImageApiResponseSchema
        }
    })
...
class ComputeImageAPI(ApiView):
    ...
    def register_api(module, rules=None, **kwargs):
        ...
        rules = [
            # image
            ('%s/computeservices/image/describeimages' % base, 'GET', DescribeImages, {}),
