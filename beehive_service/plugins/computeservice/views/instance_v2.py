...
from .instance import (
    ...
    DeleteInstanceSnapshots,
    RevertInstanceSnapshots,
    MonitorInstances,
    ForwardLogInstances,
    UnmonitorInstances,
)
...
class DescribeInstancesV20ApiResponseSchema(Schema):
    DescribeInstancesResponse = fields.Nested(
        DescribeInstancesV20Api1ResponseSchema,
        required=True,
        many=False,
        allow_none=False,
    )
...
class RunInstancesV20(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses(
        {202: {"description": "success", "schema": RunInstancesV20ApiResponseSchema}}
    )
...
class GetConsoleV20(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({202: {"description": "success", "schema": GetConsoleV20ApiResponseSchema}})
...
class DescribeInstanceTypesV20ApiResponseSchema(Schema):
    DescribeInstanceTypesResponse = fields.Nested(
        DescribeInstanceTypesV20Api1ResponseSchema,
        required=True,
        many=False,
        allow_none=False,
    )
    ...
    def register_api(module, dummyrules=None, **kwargs):
        ...
        rules = [
            ...
            (
                ...
                "GET",
                DescribeInstanceSnapshotsV20,
                {},
            ),
            (
                "%s/createinstancesnapshots" % base,
                "PUT",
                CreateInstanceSnapshotsV20,
                {},
            ),
            (
                "%s/deleteinstancesnapshots" % base,
                "PUT",
                DeleteInstanceSnapshotsV20,
                {},
            ),
            (
                "%s/revertinstancesnapshots" % base,
                "PUT",
                RevertInstanceSnapshotsV20,
                {},
            ),
            # instance monitoring
