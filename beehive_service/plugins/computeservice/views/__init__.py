...
class DescribeComputeApiResponseSchema(Schema):
    DescribeComputeResponse = fields.Nested(
...
class DescribeComputeService(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": DescribeComputeApiResponseSchema}}
    )
...
class DeleteComputeService(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses(
        {202: {"description": "success", "schema": DeleteComputeServiceResponseSchema}}
    )
...
class ComputeServiceAPI(ApiView):
    ...
    def register_api(module, dummyrules=None, **kwargs):
        ...
        rules = [
            ...
            (
                "%s/computeservices/describeaccountattributes" % base,
                "GET",
                DescribeAccountAttributes,
                {},
            ),
            (
                "%s/computeservices/modifyaccountattributes" % base,
                "PUT",
                ModifyAccountAttributes,
                {},
            ),
            (
                "%s/computeservices/describeavailabilityzones" % base,
                "GET",
                DescribeAvailabilityZonesResponse,
                {},
            ),
