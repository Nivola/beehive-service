...
class DescribeInstancesApiResponseSchema(Schema):
    DescribeInstancesResponse = fields.Nested(
        DescribeInstancesApi1ResponseSchema, required=True, many=False, allow_none=False
    )
...
class TagSpecificationMappingApiRequestSchema(Schema):
    ResourceType = fields.String(
        required=False,
        example="",
        missing=__SRV_AWS_TAGS_RESOURCE_TYPE_INSTANCE__,
...
class StartInstancesApiResponseSchema(Schema):
    StartInstancesResponse = fields.Nested(
        StateInstancesApi1ResponseSchema, required=True, many=False, allow_none=False
    )
...
class RebootInstancesApiResponseSchema(Schema):
    RebootInstancesResponse = fields.Nested(
        RebootInstancesApi1ResponseSchema, required=True, many=False, allow_none=False
    )
...
class DescribeInstanceSnapshotsApi1ResponseSchema(Schema):
    ...
    instancesSet = fields.Nested(
        DescribeInstanceSnapshotsApi2ResponseSchema,
        required=True,
        many=True,
        allow_none=True,
    )
...
class CreateInstanceSnapshotsApi1ResponseSchema(Schema):
    requestId = fields.String(required=True, default="", allow_none=True)
    instancesSet = fields.Nested(
        CreateInstanceSnapshotsApi2ResponseSchema,
        required=True,
        many=True,
        allow_none=True,
    )
...
class DeleteInstanceSnapshotsApi1ResponseSchema(Schema):
    requestId = fields.String(required=True, default="", allow_none=True)
    instancesSet = fields.Nested(
        DeleteInstanceSnapshotsApi2ResponseSchema,
        required=True,
        many=True,
        allow_none=True,
    )
...
class RevertInstanceSnapshotsApi1ResponseSchema(Schema):
    requestId = fields.String(required=True, default="", allow_none=True)
    instancesSet = fields.Nested(
        RevertInstanceSnapshotsApi2ResponseSchema,
        required=True,
        many=True,
        allow_none=True,
    )
