...
from beehive_service.plugins.computeservice.controller import ApiComputeInstance, ApiComputeService, ApiComputeVolume
...
class DescribeVolumesAttachmentSetResponseSchema(Schema):
    ...
    deleteOnTermination = fields.Bool(required=False, example='True',
...
class DescribeVolumesApi1ItemResponseSchema(Schema):
    ...
    createTime = fields.String(required=False, example='1999-03-17',
                               description='The time stamp when volume creation was initiated.')
    attachmentSet = fields.Nested(DescribeVolumesAttachmentSetResponseSchema, many=True, required=False,
                                  allow_none=False)
    ...
    nvl_hypervisor = fields.String(required=False, allow_none=True, example='vmware | openstack',
                                   description='type of the hypervisor',data_key='nvl-hypervisor')
    nvl_name = fields.String(required=False, allow_none=True, example='', description='name of the instance',
                             data_key='nvl-name')
    nvl_volumeOwnerAlias = fields.String(required=False, allow_none=True, example='', description='Owner Alias',
                                         data_key='nvl-volumeOwnerAlias')
    nvl_volumeOwnerId = fields.String(required=False, allow_none=True, example='', data_key='nvl-volumeOwnerId',
...
class DescribeVolumesApi1ResponseSchema(Schema):
    ...
    nvl_volumeTotal = fields.Integer(required=False, allow_none=True, example=2, data_key='nvl-volumeTotal',
...
class DescribeVolumesApiResponseSchema(Schema):
    DescribeVolumesResponse = fields.Nested(DescribeVolumesApi1ResponseSchema, required=True, many=False,
                                            allow_none=False)
...
class DescribeVolumesAttachmentApiRequestSchema(Schema):
    ...
    instance_id = fields.String(example='1999-09-23', required=False, allow_none=True, data_key='instance-id',
...
class DescribeVolumesApiRequestSchema(Schema):
    ...
    Nvl_Name_N = fields.List(fields.String(), required=False,  example='', description='name of the volume',
                             allow_none=True, context='query', collection_format='multi', data_key='Nvl_Name.N')
    VolumeId_N = fields.List(fields.String(example=''), required=False, allow_none=True, context='query',
                             collection_format='multi', data_key='VolumeId.N', description='volume id')
    volume_id_N = fields.List(fields.String(example=''), required=False, allow_none=True, context='query',
                              collection_format='multi', data_key='volume-id.N', description='volume id')
    volume_type_N = fields.List(fields.String(example=''), required=False, allow_none=True, context='query',
                                collection_format='multi', data_key='volume-type.N', description='The volume type.')
    status_N = fields.List(fields.String(example='', validate=OneOf(['creating', ' available', 'in-use',
                                                                     'deleting', ' deleted', 'error'])),
                           required=False, allow_none=True, context='query', collection_format='multi',
                           data_key='status.N', description='The status of the volume (creating | available | '
    ...
    create_time_N = fields.List(fields.String(example=''), required=False, allow_none=True, context='query',
                                collection_format='multi', data_key='create-time.N',
    ...
    attachment_N = fields.Nested(DescribeVolumesAttachmentApiRequestSchema, many=True, required=False, allow_none=True,
                                 context='query', collection_format='multi', data_key='attachment.N',
...
class DescribeVolumes(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': DescribeVolumesApiResponseSchema
        }
    })
    ...
    def get(self, controller: ServiceController, data: dict, *args, **kwargs):
        ...
        # get volumes list
        res, total = controller.get_service_type_plugins(service_uuid_list=volume_id_list,
...
class CreateVolumeApiParamRequestSchema(Schema):
    ...
    SnapshotId = fields.String(required=False, example='123', description='The snapshot from which to create the '
                               'volume. You must specify either a snapshot ID')
    ...
    Iops = fields.Integer(required=False, example=1000, missing=-1, description='The number of I/O operations per '
                          'second (IOPS) to provision for the volume, with a maximum ratio of xx IOPS/GiB')
    AvailabilityZone = fields.String(required=True, example='Pod1',
                                     description='The Availability Zone in which to create the volume')
    MultiAttachEnabled = fields.Bool(required=False, example=True, missing=False, description='Specifies whether to '
    ...
    Encrypted = fields.Bool(required=False, example=True, missing=False,
...
class CreateVolume(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        202: {
            'description': 'success',
            'schema': CreateVolumeApiResponseSchema
        }
    })
...
class AttachVolumeApiRequestSchema(Schema):
    ...
    VolumeId = fields.String(required=True, example='123', description='The ID of the volume. The volume and instance '
...
class AttachVolume(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        202: {
            'description': 'success',
            'schema': AttachVolumeApiResponseSchema
        }
    })
...
class DetachVolumeApi1ResponseSchema(Schema):
    ...
    status = fields.String(required=True, example='', description='volume attachment status')
    attachTime = fields.String(required=True, example='', description='volume attachment status')
    deleteOnTermination = fields.Bool(required=True, example='True',
                                      description='Indicates whether the volume is deleted on instance termination.')
...
class DetachVolumeApiRequestSchema(Schema):
    Force = fields.Bool(required=False, example=True, missing=False, description='Forces detachment if the previous '
...
class DetachVolume(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        202: {
            'description': 'success',
            'schema': DetachVolumeApiResponseSchema
        }
    })
...
class DescribeVolumeTypesApiResponseSchema(Schema):
    DescribeVolumeTypesResponse = fields.Nested(DescribeVolumeTypesApi1ResponseSchema, required=True, many=False,
                                                allow_none=False)


class DescribeVolumeTypesApiRequestSchema(Schema):
    MaxResults = fields.Integer(required=False, default=10,
                                description='entities list page size', context='query')
    NextToken = fields.String(required=False, default='0',
                              description='entities list page selected', context='query')
    volume_type_N = fields.List(fields.String(example=''), required=False, allow_none=True, context='query',
                                collection_format='multi', data_key='volume-type.N',
...
class DescribeVolumeTypes(ServiceApiView):
    ...
    def get(self, controller: ServiceController, data: dict, *args, **kwargs):
        ...
        volume_types_set, total = controller.get_catalog_service_definitions(
            ...
            plugintype='ComputeVolume', def_uuids=data.pop('volume_type_N', []))
