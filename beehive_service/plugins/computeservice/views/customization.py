    ...
    name = fields.String(
        ...
        validate=OneOf(
            [
                ...
                for x in dir(ApiComputeCustomization.state_enum)
...
class DescribeCustomizationSetResponseSchema(Schema):
    ...
    args = fields.Nested(
        DescribeCustomizationSetArgResponseSchema,
        required=True,
        many=True,
        allow_none=False,
...
class DescribeCustomizationsApiResponseSchema(Schema):
    DescribeCustomizationsResponse = fields.Nested(
        DescribeCustomizationsApi1ResponseSchema,
        required=True,
        many=False,
        allow_none=False,
    )
...
class DescribeCustomizations(ServiceApiView):
    ...
    def get(self, controller: ServiceController, data: Dict, *args, **kwargs):
        ...
        res, total = controller.get_service_type_plugins(
            service_uuid_list=customization_id_list,
...
class DescribeCustomizationTypesApiResponseSchema(Schema):
    DescribeCustomizationTypesResponse = fields.Nested(
        DescribeCustomizationTypesApi1ResponseSchema,
        required=True,
        many=False,
        allow_none=False,
    )
...
class RunCustomization(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses(
        {202: {"description": "success", "schema": RunCustomizationsApiResponseSchema}}
    )
...
class UpdateCustomizationResponseSchema(Schema):
    UpdateCustomizationResponse = fields.Nested(
        UpdateCustomizationResponseItemSchema,
        required=True,
        many=False,
        allow_none=False,
    )
...
class UpdateCustomization(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": UpdateCustomizationResponseSchema}}
    )
...
class TerminateCustomizationResponseSchema(Schema):
    TerminateCustomizationResponse = fields.Nested(
        TerminateCustomizationResponseItemSchema,
        required=True,
        many=False,
        allow_none=False,
    )
...
class ComputeCustomizationAPI(ApiView):
    ...
    def register_api(module, dummyrules=None, **kwargs):
        ...
        rules = [
            ...
            # customization types
            (
                "%s/describecustomizationtypes" % base,
                "GET",
                DescribeCustomizationTypes,
                {},
            ),
        ]
