...
class DescribeDBInstanceTypesApiV2ResponseSchema(Schema):
    DescribeDBInstanceTypesResponse = fields.Nested(DescribeDBInstanceTypesApi1V2ResponseSchema, required=True,
...
class DescribeDBInstanceTypes(ServiceApiView):
    ...
    def get(self, controller, data, *args, **kwargs):
        ...
        instance_types_set, total = account.get_definitions(plugintype=ApiDatabaseServiceInstance.plugintype,
...
class DescribeDBInstanceEngineTypesApi1V2ResponseSchema(Schema):
    ...
    engineTypesSet = fields.Nested(DescribeDBInstanceEngineTypesParamsApiV2ResponseSchema, many=True, allow_none=False,
                                   example='', description='')
...
class DescribeDBInstanceEngineTypesApiV2ResponseSchema(Schema):
    DescribeDBInstanceEngineTypesResponse = fields.Nested(DescribeDBInstanceEngineTypesApi1V2ResponseSchema,
...
class AvailabilityZoneResponseSchema(Schema):
    AvailabilityZone = fields.Nested(AVZoneV2ResponseSchema, many=False, allow_none=False, example='',
                                           description='')

class SubnetV2ResponseSchema(Schema):
    SubnetAvailabilityZone = fields.Nested(AvailabilityZoneResponseSchema, many=False, allow_none=False, example='',
                                           description='')
...
class DBParameterGroupStatusV2ResponseSchema(Schema):
    DBParameterGroup = fields.Nested(DBParameterGroupStatus1V2ResponseSchema, many=False, required=False,
                                     allow_none=False)
...
class DBSecurityGroupMembershipV2ResponseSchema(Schema):
    DBSecurityGroupMembership = fields.Nested(DBSecurityGroupMembership1V2ResponseSchema, many=False, required=False,
                                              allow_none=False)
...
class EndpointV2ResponseSchema(Schema):
    Address = fields.String(required=False, allow_none=True, description='the DNS address of the DB instance')
    # HostedZoneId = fields.String(required=False, example='', description= '')
    Port = fields.Integer(required=False, allow_none=True, description='the port that the database engine is listening on')


class OptionGroupMembership1V2ResponseSchema(Schema):
    OptionGroupName = fields.String(required=False, allow_none=True, example='',
                                    description='name of the option group that the instance belongs to')
    Status = fields.String(required=False, allow_none=True, example='',
                           description='status of the DB instance option group membership')


class OptionGroupMembershipV2ResponseSchema(Schema):
    OptionGroupMembership = fields.Nested(OptionGroupMembership1V2ResponseSchema, many=False, required=False,
                                          allow_none=False)


class DBInstanceStatusInfoV2ResponseSchema(Schema):
    Message = fields.String(required=False, allow_none=True, example='', description='Details of the error if there is '
                            'an error for the instance. If the instance is not in an error state, this value is blank')
    Normal = fields.Boolean(required=False, allow_none=True, example=True, description='Boolean value that is true if '
                            'the instance is operating normally, or false if the instance is in an error state.')
    Status = fields.String(required=False, allow_none=True, example='', description='Status of the DB instance. For a '
    ...
    StatusType = fields.String(required=False, allow_none=True, example='read replication',
                               description='This value is currently "read replication"')


class VpcSecurityGroupMembership1V2ResponseSchema(Schema):
    nvl_vpcSecurityGroupName = fields.String(required=False, allow_none=True, data_key='nvl-vpcSecurityGroupName',
                                             example='', description='name of the VPC security group')
    VpcSecurityGroupId = fields.String(required=False, example='', description='ID of the VPC security group')
    Status = fields.String(required=False, allow_none=True, example='', description='status of the VPC security group')


class VpcSecurityGroupMembershipV2ResponseSchema(Schema):
    VpcSecurityGroupMembership = fields.Nested(VpcSecurityGroupMembership1V2ResponseSchema, many=False, required=False,
                                               allow_none=True)


class ProcessorFeaturesV2ResponseSchema(Schema):
    Name = fields.String(required=False, allow_none=True, example='coreCount', description='The name of the processor '
                         'feature. Valid names are coreCount and threadsPerCore.')
    Value = fields.String(required=False, allow_none=True, example='2',
...
class DBInstanceParameterV2ResponseSchema(Schema):
    ...
    CharacterSetName = fields.String(required=False, allow_none=True, missing='latin1', description='For supported engines, '
                                     'indicates that the DB instance should be  associated with the specified '
                                     'CharacterSet.')
    DBInstanceClass = fields.String(required=False, example='db.m4.large', description='The compute and memory capacity'
                                    ' of the DB instance')
    DBInstanceIdentifier = fields.String(required=False, example='', description='The DB instance identifier')
    DbInstancePort = fields.Integer(required=False, allow_none=True, example=3306, description='Specifies the port that the DB instance '
                                    'listens on. If the DB instance is part of a DB cluster, this can be a different '
                                    'port than the DB cluster port.')
    DBInstanceStatus = fields.String(required=False, example='available',
                                     description='Specifies the current state of this database.')
    DbiResourceId = fields.String(required=False, allow_none=True, example='1234',
                                  description='The Region-unique, immutable identifier for the DB instance. ')
    DBName = fields.String(required=False, allow_none=True, example='', description='The name of the database to create when the DB '
                           'instance is created. ')
    ...
    Endpoint = fields.Nested(EndpointV2ResponseSchema, many=False, required=False, allow_none=False,
    ...
    LicenseModel = fields.String(required=False, allow_none=True, example='',
    ...
    StatusInfos = fields.Nested(DBInstanceStatusInfoV2ResponseSchema, many=True, required=False, allow_none=True,
                                description='The status of a read replica. If the instance is not a read replica, '
                                            'this is blank')
    StorageEncrypted = fields.Boolean(required=False, allow_none=True, example=False,
                                      description='Specifies whether the DB instance is encrypted')
    StorageType = fields.String(required=False, allow_none=True, example='',
                                description='Specifies the storage type associated with DB instance')
    TagList = fields.Nested(TagSetV2ResponseSchema, many=True, required=False, allow_none=True,
                            description='A list of tags')
    Timezone = fields.String(required=False, allow_none=True, example='Europe/Rome',
                             description='The time zone of the DB instance')
    VpcSecurityGroups = fields.Nested(VpcSecurityGroupMembershipV2ResponseSchema, many=True, required=False,
                                      allow_none=True)
    nvl_stateReason = fields.Nested(StateReasonV2ResponseSchema, many=True, required=False,
...
class CreateDBInstanceResultApiV2ResponseSchema(Schema):
    ...
    CreateDBInstanceResult = fields.Nested(CreateDBInstanceApiV2ResponseSchema, required=True, many=False,
                                           allow_none=False)


class CreateDBInstanceV2ResponseSchema(Schema):
    CreateDBInstanceResponse = fields.Nested(CreateDBInstanceResultApiV2ResponseSchema, required=True, many=False,
                                             allow_none=False)
...
class NvlOracleOptionsV2RequestSchema(Schema):
    ora_dbname = fields.String(required=False, description='Oracle database name', data_key='Oracle.DBName',)
    ...
    ora_partopt = fields.String(required=False, description='Oracle partitioning option', data_key='Oracle.PartOption')
    ora_charset = fields.String(required=False, description='Oracle database character set', data_key='Oracle.CharSet')
    ora_natcharset = fields.String(required=False, description='Oracle database national character set',
                                   data_key='Oracle.NatCharSet')
    ora_dbfdisksize = fields.Integer(required=False, description='Oracle database datafiles disk size',
                                     data_key='Oracle.DbfDiskSize')
    ora_recodisksize = fields.Integer(required=False, description='Oracle database recovery disk size',
                                      data_key='Oracle.RecoDiskSize')


class NvlPostgresqlOptionsV2RequestSchema(Schema):
    Postgresql_GeoExtension = fields.String(required=False, missing=True, data_key='Postgresql.GeoExtension',
...
class CreateDBInstancesApiParamV2RequestSchema(Schema):
    ...
    AllocatedStorage = fields.Integer(Required=False, example=30, missing=30,
                                      description='amount of storage (in GB) to allocate for the DB instance')
    # BackupRetentionPeriod
    CharacterSetName = fields.String(required=False, example='', missing='latin1', description='For supported engines, '
                                     'indicates that the DB instance should be associated with the specified '
                                     'CharacterSet.')
    ...
    #                     is 0.
    MultiAZ = fields.Boolean(required=False, missing=False, description='A value that indicates whether the DB instance'
    ...
    Port = fields.String(required=False, example='', missing=None, description='The port number on which the database '
    ...
    Nvl_KeyName = fields.String(required=False, example='1ffd', allow_none=True,
                                description='The name of the key pair')
    Timezone = fields.String(required=False, example='Europe/Rome', missing='Europe/Rome',
                             description='characterSet of DB instance')
    VpcSecurityGroupIds = fields.Nested(VpcSecurityGroupId_NV2RequestSchema, many=False, required=False,
                                        allow_none=False, description='a DB security groups to associate with DB '
                                                                      'instance')
    Nvl_Oracle_Options = fields.Nested(NvlOracleOptionsV2RequestSchema, required=False, allow_none=True,
                                       description='Configure Oracle database options')
    Nvl_Postgresql_Options = fields.Nested(NvlPostgresqlOptionsV2RequestSchema, required=False, allow_none=True,
                                           description='Configure Postgresql database options')
    Nvl_Mysql_Options = fields.Nested(NvlMysqlOptionsV2RequestSchema, required=False, allow_none=True,
...
class CreateDBInstances(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        202: {
            'description': 'success',
            'schema': CreateDBInstanceV2ResponseSchema
        }
    })
    ...
    def post(self, controller, data, *args, **kwargs):
        ...
        service_defs, total = controller.get_paginated_service_defs(
            service_definition_uuid_list=[service_definition_id], plugintype=ApiDatabaseServiceInstance.plugintype)
...
class DescribeDBInstancesV2RequestSchema(Schema):
    ...
    db_cluster_id = fields.List(fields.String(), required=False, allow_none=True, context='query',
                                collection_format='multi', data_key='db-cluster-id.N',
                                description='Accepts DB cluster identifiers and DB cluster Names')
    db_instance_id_N = fields.List(fields.String(), required=False, allow_none=True, context='query',
                                   collection_format='multi', data_key='db-instance-id.N',
...
class DescribeDBInstances(ServiceApiView):
    ...
    responses = ServiceApiView.setResponses({
        200: {
            'description': 'success',
            'schema': DescribeDBInstancesV2ResponseSchema
        }
    })
...
class DeleteDBInstanceResultV2ResponseSchema(Schema):
    xmlns = fields.String(required=False, data_key='__xmlns')
    DeleteDBInstanceResult = fields.Nested(DeleteDBInstanceV2ResponseSchema, many=False, required=False,
                                           allow_none=False)
    ResponseMetadata = fields.Nested(DBResponseMetadataV2ResponseSchema, many=False, required=False, allow_none=True)


class DeleteDBInstancesApiV2ResponseSchema(Schema):
    DeleteDBInstanceResponse = fields.Nested(DeleteDBInstanceResultV2ResponseSchema, required=True, many=False,
                                             allow_none=False)


class DeleteDBInstancesApiV2RequestSchema(Schema):
    DBInstanceIdentifier = fields.String(required=True, context='query', description='The DB instance identifier for '
                                         'the DB instance to be deleted')
    ...
    SkipFinalSnapshot = fields.String(required=False, allow_none=True, context='query', description='Determines whether'
...
class ModifyDBInstanceApiV2ResultResponseSchema(Schema):
    ModifyDBInstanceResult = fields.Nested(ModifyDBInstanceApiV2Result1ResponseSchema, many=False, required=False,
                                           allow_none=False)


class ModifyDBInstanceApiV2ResponseSchema(Schema):
    ModifyDBInstanceResponse = fields.Nested(ModifyDBInstanceApiV2ResultResponseSchema, required=True, many=False,
                                             allow_none=False)


class ModifyDBInstanceApiV2SgRequestSchema(Schema):
    VpcSecurityGroupId = fields.List(fields.String(), required=True, description='security group id followed by :ADD '
                                                                                 'to add and :DEL to remove')


class ModifyDBInstanceApiV2ExtensionRequestSchema(Schema):
    Name = fields.String(required=True, description='Extension name')
    Type = fields.String(required=True, description='Extension type', validate=OneOf(['plugin', 'component']))
...
class ModifyDBInstanceApiV2RequestSchema(Schema):
    ...
    AllocatedStorage = fields.Integer(required=False, example=100, description='The new amount of storage space, in '
                                      'gibibytes (GiB), to allocate to the DB instance')
    DBInstanceClass = fields.String(required=False, allow_none=True, description='The new compute and memory capacity '
                                    'of the DB instance, for example db.m4.large')
    VpcSecurityGroupIds = fields.Nested(ModifyDBInstanceApiV2SgRequestSchema, many=False, required=False,
                                        allow_none=False, description='Changes the security groups of the DB instance')
    Extensions = fields.Nested(ModifyDBInstanceApiV2ExtensionRequestSchema, required=False, many=True, allow_none=True,
...
class ModifyDBInstance(ServiceApiView):
    ...
    description = 'Modifies the specified attribute of the specified db instance. You can specify only one attribute ' \
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ModifyDBInstanceApiV2ResponseSchema
        }
    })
    ...
    def put(self, controller, data, *args, **kwargs):
        ...
        if service_definition_id is not None:
            ...
            service_defs, total = controller.get_paginated_service_defs(
                service_definition_id_list=[service_def.oid], plugintype=ApiDatabaseServiceInstance.plugintype)
...
class StopDBInstanceApiV2ResultResponseSchema(Schema):
    xmlns = fields.String(required=False, data_key='__xmlns')
    StopDBInstanceResult = fields.Nested(StopDBInstanceApiV2Result1ResponseSchema, many=False, required=False, allow_none=False)
    ResponseMetadata = fields.Nested(DBResponseMetadataV2ResponseSchema, many=False, required=False, allow_none=True)


class StopDBInstanceApiV2ResponseSchema(Schema):
    StopDBInstanceResponse = fields.Nested(StopDBInstanceApiV2ResultResponseSchema, required=True, many=False,
                                           allow_none=False)


class StopDBInstanceApiV2RequestSchema(Schema):
    DBInstanceIdentifier = fields.String(required=True, context='query', description='The DB instance identifier for '
                                         'the DB instance to stop')
...
class StopDBInstance(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': StopDBInstanceApiV2ResponseSchema
        }
    })
...
class StartDBInstanceApiV2ResultResponseSchema(Schema):
    xmlns = fields.String(required=False, data_key='__xmlns')
    StartDBInstanceResult = fields.Nested(StartDBInstanceApiV2Result1ResponseSchema, many=False, required=False, allow_none=False)
    ResponseMetadata = fields.Nested(DBResponseMetadataV2ResponseSchema, many=False, required=False, allow_none=True)


class StartDBInstanceApiV2ResponseSchema(Schema):
    StartDBInstanceResponse = fields.Nested(StartDBInstanceApiV2ResultResponseSchema, required=True, many=False,
                                            allow_none=False)


class StartDBInstanceApiV2RequestSchema(Schema):
    DBInstanceIdentifier = fields.String(required=True, context='query', description='The DB instance identifier for '
                                         'the DB instance to start')
...
class StartDBInstance(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': StartDBInstanceApiV2ResponseSchema
        }
    })
...
class RebootDBInstanceApiV2ResultResponseSchema(Schema):
    xmlns = fields.String(required=False, data_key='__xmlns')
    RebootDBInstanceResult = fields.Nested(RebootDBInstanceApiV2Result1ResponseSchema, many=False, required=False, allow_none=False)
    ResponseMetadata = fields.Nested(DBResponseMetadataV2ResponseSchema, many=False, required=False, allow_none=True)


class RebootDBInstanceApiV2ResponseSchema(Schema):
    RebootDBInstanceResponse = fields.Nested(RebootDBInstanceApiV2ResultResponseSchema, required=True, many=False, allow_none=False)


class RebootDBInstanceApiV2RequestSchema(Schema):
    DBInstanceIdentifier = fields.String(required=True, context='query', description='The DB instance identifier for '
                                         'the DB instance to reboot')
...
class RebootDBInstance(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': RebootDBInstanceApiV2ResponseSchema
        }
    })
...
class DescribeDBInstanceSchemaApiV2Result2ResponseSchema(Schema):
    ...
    access_privileges = fields.String(required=False, allow_none=True, description='The database or schema access privileges')


class DescribeDBInstanceSchemaApiV2Result1ResponseSchema(Schema):
    Schemas = fields.Nested(DescribeDBInstanceSchemaApiV2Result2ResponseSchema, many=True, required=False, allow_none=True)
...
class DescribeDBInstanceSchemaApiV2ResultResponseSchema(Schema):
    xmlns = fields.String(required=False, data_key='__xmlns')
    DescribeDBInstanceSchemaResult = fields.Nested(DescribeDBInstanceSchemaApiV2Result1ResponseSchema, many=False,
                                                   required=False, allow_none=False)
    ResponseMetadata = fields.Nested(DBResponseMetadataV2ResponseSchema, many=False, required=False, allow_none=True)


class DescribeDBInstanceSchemaApiV2ResponseSchema(Schema):
    DescribeDBInstanceSchemaResponse = fields.Nested(DescribeDBInstanceSchemaApiV2ResultResponseSchema, required=True,
                                                 many=False, allow_none=False)
...
class CreateDBInstanceSchemaApiV2ResultResponseSchema(Schema):
    xmlns = fields.String(required=False, data_key='__xmlns')
    CreateDBInstanceSchemaResult = fields.Nested(CreateDBInstanceSchemaApiV2Result1ResponseSchema, many=False,
                                                 required=False, allow_none=False)
    ResponseMetadata = fields.Nested(DBResponseMetadataV2ResponseSchema, many=False, required=False, allow_none=True)


class CreateDBInstanceSchemaApiV2ResponseSchema(Schema):
    CreateDBInstanceSchemaResponse = fields.Nested(CreateDBInstanceSchemaApiV2ResultResponseSchema, required=True,
                                                   many=False, allow_none=False)
...
class DeleteDBInstanceSchemaApiV2ResultResponseSchema(Schema):
    xmlns = fields.String(required=False, data_key='__xmlns')
    DeleteDBInstanceSchemaResult = fields.Nested(DeleteDBInstanceSchemaApiV2Result1ResponseSchema, many=False, required=False,
                                                 allow_none=False)
    ResponseMetadata = fields.Nested(DBResponseMetadataV2ResponseSchema, many=False, required=False, allow_none=True)


class DeleteDBInstanceSchemaApiV2ResponseSchema(Schema):
    DeleteDBInstanceSchemaResponse = fields.Nested(DeleteDBInstanceSchemaApiV2ResultResponseSchema, required=True, many=False,
                                                   allow_none=False)
...
class DescribeDBInstanceUserApiV2ResultResponseSchema(Schema):
    xmlns = fields.String(required=False, data_key='__xmlns')
    DescribeDBInstanceUserResult = fields.Nested(DescribeDBInstanceUserApiV2Result1ResponseSchema, many=False,
                                                 required=False, allow_none=False)
    ResponseMetadata = fields.Nested(DBResponseMetadataV2ResponseSchema, many=False, required=False, allow_none=True)


class DescribeDBInstanceUserApiV2ResponseSchema(Schema):
    DescribeDBInstanceUserResponse = fields.Nested(DescribeDBInstanceUserApiV2ResultResponseSchema, required=True,
                                                   many=False, allow_none=False)
...
class CreateDBInstanceUserApiV2ResultResponseSchema(Schema):
    xmlns = fields.String(required=False, data_key='__xmlns')
    CreateDBInstanceUserResult = fields.Nested(CreateDBInstanceUserApiV2Result1ResponseSchema, many=False, required=False, allow_none=False)
    ResponseMetadata = fields.Nested(DBResponseMetadataV2ResponseSchema, many=False, required=False, allow_none=True)


class CreateDBInstanceUserApiV2ResponseSchema(Schema):
    CreateDBInstanceUserResponse = fields.Nested(CreateDBInstanceUserApiV2ResultResponseSchema, required=True,
                                                 many=False, allow_none=False)
...
class DeleteDBInstanceUserApiV2ResultResponseSchema(Schema):
    xmlns = fields.String(required=False, data_key='__xmlns')
    DeleteDBInstanceUserResult = fields.Nested(DeleteDBInstanceUserApiV2Result1ResponseSchema, many=False,
                                               required=False, allow_none=False)
    ResponseMetadata = fields.Nested(DBResponseMetadataV2ResponseSchema, many=False, required=False, allow_none=True)


class DeleteDBInstanceUserApiV2ResponseSchema(Schema):
    DeleteDBInstanceUserResponse = fields.Nested(DeleteDBInstanceUserApiV2ResultResponseSchema, required=True,
                                                 many=False, allow_none=False)
...
class ChangeDBInstanceUserPasswordApiV2ResultResponseSchema(Schema):
    xmlns = fields.String(required=False, data_key='__xmlns')
    ChangeDBInstanceUserPasswordResult = fields.Nested(ChangeDBInstanceUserPasswordApiV2Result1ResponseSchema,
                                                       many=False, required=False, allow_none=False)
    ResponseMetadata = fields.Nested(DBResponseMetadataV2ResponseSchema, many=False, required=False, allow_none=True)


class ChangeDBInstanceUserPasswordApiV2ResponseSchema(Schema):
    ChangeDBInstanceUserPasswordResponse = fields.Nested(ChangeDBInstanceUserPasswordApiV2ResultResponseSchema,
                                                         required=True, many=False, allow_none=False)
    ...
    def put(self, controller, data, *args, **kwargs):
        ...
        res = {
            'ChangeDBInstanceUserPasswordResponse': {
                '__xmlns': self.xmlns,
                'ChangeDBInstanceUserPasswordResult': {
                    'Name': name
                },
                'ResponseMetadata': {
                    'RequestId': operation.id,
...
class GrantDBInstanceUserPrivilegesApiV2Result1ResponseSchema(Schema):
    ...
    Privileges = fields.String(required=False, example='ALL', description='The privileges string like SELECT,INSERT,'
                                                                          'DELETE,UPDATE or ALL')


class GrantDBInstanceUserPrivilegesApiV2ResultResponseSchema(Schema):
    xmlns = fields.String(required=False, data_key='__xmlns')
    GrantDBInstanceUserPrivilegesResult = fields.Nested(GrantDBInstanceUserPrivilegesApiV2Result1ResponseSchema,
                                                        many=False, required=False, allow_none=False)
    ResponseMetadata = fields.Nested(DBResponseMetadataV2ResponseSchema, many=False, required=False, allow_none=True)


class GrantDBInstanceUserPrivilegesApiV2ResponseSchema(Schema):
    GrantDBInstanceUserPrivilegesResponse = fields.Nested(GrantDBInstanceUserPrivilegesApiV2ResultResponseSchema,
                                                          required=True, many=False, allow_none=False)


class GrantDBInstanceUserPrivilegesApiV2RequestSchema(Schema):
    DBInstanceIdentifier = fields.String(required=True, description='The DB instance identifier')
    DbName = fields.String(required=True, exmaple='testdb', description='database name. For postgres use db1 to select '
                           'a database db1 and db1.schema1 to select schema schema1 in database db1')
    UserName = fields.String(required=True, example='testuser', description='The user name')
    Privileges = fields.String(required=False, example='ALL', missing='ALL',
...
class RevokeDBInstanceUserPrivilegesApiV2ResultResponseSchema(Schema):
    xmlns = fields.String(required=False, data_key='__xmlns')
    RevokeDBInstanceUserPrivilegesResult = fields.Nested(RevokeDBInstanceUserPrivilegesApiV2Result1ResponseSchema,
                                                         many=False, required=False, allow_none=False)
    ResponseMetadata = fields.Nested(DBResponseMetadataV2ResponseSchema, many=False, required=False, allow_none=True)


class RevokeDBInstanceUserPrivilegesApiV2ResponseSchema(Schema):
    RevokeDBInstanceUserPrivilegesResponse = fields.Nested(RevokeDBInstanceUserPrivilegesApiV2ResultResponseSchema,
                                                           required=True, many=False, allow_none=False)
...
class DBInstanceStateResponseSchema(Schema):
    code = fields.Integer(required=False, allow_none=True, example='0', description='code of DB instance state')
    name = fields.String(required=False, example='pending | running | ....', description='name of DB instance state',
...
class MonitorDBInstancesApiResponseSchema(Schema):
    MonitorDBInstancesResponse = fields.Nested(StateDBInstancesApi1ResponseSchema, required=True, many=False,
                                               allow_none=False)


class MonitorDBInstancesApiRequestSchema(Schema):
    owner_id_N = fields.List(fields.String(example=''), required=False, allow_none=False, collection_format='multi',
                             data_key='owner-id.N', description='account ID of the DB instance owner')
    DBInstanceIdentifier = fields.List(fields.String(example=''), required=True, allow_none=True,
                                       collection_format='multi', data_key='DBInstanceId.N',
...
class MonitorDBInstances(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        202: {
            'description': 'success',
            'schema': MonitorDBInstancesApiResponseSchema
        }
    })
...
class ForwardLogDBInstancesApiResponseSchema(Schema):
    ForwardLogDBInstancesResponse = fields.Nested(StateDBInstancesApi1ResponseSchema, required=True, many=False,
                                                  allow_none=False)
...
class ForwardLogDBInstancesApiRequestSchema(Schema):
    ...
    Pipeline = fields.String(required=False, allow_none=True, missing=None, description='Log collector pipeline port')
...
class DatabaseInstanceV2API(ApiView):
    ...
    def register_api(module, rules=None, **kwargs):
        ...
        rules = [
            ...
            ('%s/changedbinstanceuserpassword' % base, 'PUT', ChangeDBInstanceUserPassword, {}),
            ('%s/grantdbinstanceuserprivileges' % base, 'POST', GrantDBInstanceUserPrivileges, {}),
            ('%s/revokedbinstanceuserprivileges' % base, 'DELETE', RevokeDBInstanceUserPrivileges, {}),
