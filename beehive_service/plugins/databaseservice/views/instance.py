...
class SubnetResponseSchema(Schema):
    SubnetAvailabilityZone = fields.Nested(
        AVZoneResponseSchema, many=False, allow_none=False, example="", description=""
    )
...
class DBInstanceStatusInfoResponseSchema(Schema):
    Message = fields.String(required=False, allow_none=True, example="", description="")
    Normal = fields.Boolean(required=False, allow_none=True, example="", description="")
    Status = fields.String(required=False, allow_none=True, example="", description="")
    StatusType = fields.String(required=False, allow_none=True, example="", description="")
...
class CreateDBInstances2ApiResponseSchema(Schema):
    ...
    DBInstanceClass = fields.String(required=False, allow_none=True, example="", description="")
    DBInstanceIdentifier = fields.String(required=False, allow_none=True, example="", description="")
    DbInstancePort = fields.Integer(required=False, allow_none=True, example="", description="")
    DBInstanceStatus = fields.String(required=False, allow_none=True, example="", description="")
    DBIResourceId = fields.String(required=False, allow_none=True, example="", description="")
    DBName = fields.String(required=False, allow_none=True, example="", description="")
    ...
    Engine = fields.String(required=False, example="", description="")
    EngineVersion = fields.String(required=False, example="", description="")
    EnhancedMonitoringResourceArn = fields.String(required=False, example="", description="")
    IAMDatabaseAuthenticationEnabled = fields.Boolean(required=False, example="", description="")
    InstanceCreateTime = fields.DateTime(required=False, example="", description="")
    Iops = fields.Integer(required=False, example="", description="")
    KmsKeyId = fields.String(required=False, example="", description="")
    LatestRestorableTime = fields.DateTime(required=False, example="", description="")
    LicenseModel = fields.String(required=False, example="", description="")
    MasterUsername = fields.String(required=False, example="", description="")
    MonitoringInterval = fields.Integer(required=False, example="", description="")
    MonitoringRoleArn = fields.String(required=False, example="", description="")
    MultiAZ = fields.Boolean(required=False, example="", description="")

    OptionGroupMemberships = fields.Nested(
        OptionGroupMembershipResponseSchema, many=True, required=False, allow_none=True
    )
    PendingModifiedValues = fields.Nested(
        PendingModifiedValuesResponseSchema, many=False, required=False, allow_none=True
    )

    PerformanceInsightsEnabled = fields.Boolean(required=False, example="", description="")
    PerformanceInsightsKMSKeyId = fields.String(required=False, example="", description="")
    PreferredBackupWindow = fields.String(required=False, example="", description="")
    PreferredMaintenanceWindow = fields.String(required=False, example="", description="")
    PromotionTier = fields.Integer(required=False, example="", description="")
    PubliclyAccessible = fields.Boolean(required=False, example="", description="")
    ...
    ReadReplicaSourceDBInstanceIdentifier = fields.String(required=False, example="", description="")
    SecondaryAvailabilityZone = fields.String(required=False, example="", description="")
    StatusInfos = fields.Nested(DBInstanceStatusInfoResponseSchema, many=True, required=False, allow_none=True)
    StorageEncrypted = fields.Boolean(required=False, example="", description="")
    StorageType = fields.String(required=False, example="", description="")
    TdeCredentialArn = fields.String(required=False, example="", description="")
    Timezone = fields.String(required=False, example="", description="")
...
class CreateDBInstanceResultApiResponseSchema(Schema):
    CreateDBInstanceResult = fields.Nested(
        CreateDBInstanceApiResponseSchema, required=True, many=False, allow_none=False
    )
...
class CreateDBInstancesApiParamRequestSchema(Schema):
    ...
    DBName = fields.String(
        ...
        missing="mydbname",
        example="",
        description="name of instance database to create",
