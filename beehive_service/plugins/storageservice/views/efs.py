...
class DescribeMountTargetsResponseSchema(Schema):
    MountTargets = fields.Nested(
        DescribeMountTargetNestedResponseSchema,
        required=True,
        many=True,
        allow_none=True,
    )
...
class DeleteFileSystemGrantRequestSchema(Schema):
    grant = fields.Nested(
        DeleteFileSystemGrantParamRequestSchema,
        required=True,
        many=False,
        allow_none=False,
    )
...
class StorageEfsServiceAPI(ApiView):
    ...
    def register_api(module, dummyrules=None, version=None, **kwargs):
        ...
        rules = [
            (
                "%s/storageservices/efs/file-systems" % base,
                "POST",
                CreateFileSystem,
                {},
            ),
            ...
            (
                "%s/storageservices/efs/file-systems/<oid>" % base,
                "PUT",
                UpdateFileSystem,
                {},
            ),
            ...
            (
                "%s/storageservices/efs/mount-targets" % base,
                "POST",
                CreateMountTarget,
                {},
            ),
            ...
            (
                "%s/storageservices/efs/mount-targets/<oid>/grants" % base,
                "POST",
