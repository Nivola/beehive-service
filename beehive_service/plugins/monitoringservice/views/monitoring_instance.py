...
from beehive.common.apimanager import ApiManagerError, SwaggerApiView, GetApiObjectRequestSchema, PaginatedRequestQuerySchema, ApiView, \
    ApiManagerWarning
from beehive_service.plugins.monitoringservice.controller import ApiMonitoringService, ApiMonitoringInstance
...
class CreateMonitoringInstanceApiResponseSchema(Schema):
    CreateMonitoringInstanceResponse = fields.Nested(CreateMonitoringInstanceApiResponse1Schema, required=True, many=False,
                                                  allow_none=False)
...
class CreateMonitoringInstance(ServiceApiView):
    ...
    def post(self, controller: ServiceController, data: dict, *args, **kwargs):
        ...
        name = 'MonitoringInstance-%s' % compute_service_instance.name
...
class MonitoringInstanceItemParameterResponseSchema(Schema):
    ...
    stateReason = fields.Nested(MonitoringInstanceStateReasonResponseSchema, many=False, required=True,
...
class DescribeMonitoringInstances1ResponseSchema(Schema):
    ...
    nvl_instanceTotal = fields.Integer(required=False, example='0', descriptiom='total monitoring instance',
                                       data_key='nvl-instanceTotal')


class DescribeMonitoringInstancesResponseSchema(Schema):
    DescribeMonitoringInstancesResponse = fields.Nested(DescribeMonitoringInstances1ResponseSchema, required=True, many=False,
                                                     allow_none=False)
...
class MonitoringInstanceServiceAPI(ApiView):
    ...
    def register_api(module, rules=None, version=None, **kwargs):
        ...
        rules = [
            ...
            ('%s/instance/deleteteinstance' % base, 'DELETE', DeleteMonitoringInstance, {}),
            ('%s/instance/describeinstances' % base, 'GET', DescribeMonitoringInstances, {}),
        ]
