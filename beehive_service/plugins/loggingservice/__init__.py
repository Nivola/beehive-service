...
from beehive_service.plugins.loggingservice.controller import ApiLoggingInstance, ApiLoggingService
...
from beehive_service.plugins.loggingservice.views.logging_instance import LoggingInstanceServiceAPI
