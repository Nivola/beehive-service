...
from beehive_service.plugins.computeservice.controller import ApiComputeService, ApiComputeInstance
...
from beehive.common.apimanager import ApiManagerError, SwaggerApiView, GetApiObjectRequestSchema, PaginatedRequestQuerySchema, ApiView, \
    ApiManagerWarning
from beehive_service.plugins.loggingservice.controller import ApiLoggingService, ApiLoggingInstance
...
class CreateLoggingInstanceApiResponse1Schema(Schema):
    ...
    requestId = fields.String(required=True, example='29647df5-5228-46d0-a2a9-09ac9d84c099',
                              description='api request id')
    instanceId = fields.String(required=True, example='29647df5-5228-46d0-a2a9-09ac9d84c099', description='instance id')
...
class CreateLoggingInstanceApiResponseSchema(Schema):
    CreateLoggingInstanceResponse = fields.Nested(CreateLoggingInstanceApiResponse1Schema, required=True, many=False,
                                                  allow_none=False)
...
class CreateLoggingInstance(ServiceApiView):
    ...
    def post(self, controller: ServiceController, data: dict, *args, **kwargs):
        ...
        compute_service_instance = controller.check_service_instance(compute_instance_id, ApiComputeInstance,
                                                                     account=account.oid)
        data['ComputeInstanceId'] = compute_service_instance.uuid
        name = 'LoggingInstance-%s' % compute_service_instance.name
...
class DeleteLoggingInstanceApiResponse1Schema(Schema):
    ...
    requestId = fields.String(required=True, example='29647df5-5228-46d0-a2a9-09ac9d84c099',
                              description='api request id')
    instanceId = fields.String(required=False, example='29647df5-5228-46d0-a2a9-09ac9d84c099', description='instance id')
    nvl_activeTask = fields.String(required=True, example='29647df5-5228-46d0-a2a9-09ac9d84c099',
                                   data_key='nvl-activeTask', description='task id')
...
class LoggingInstanceStateReasonResponseSchema(Schema):
    ...
    nvl_message = fields.String(required=False, allow_none=True, example='', description='state message', data_key='nvl-message')


class LoggingInstanceItemParameterResponseSchema(Schema):
    id = fields.String(required=True, example='075df680-2560-421c-aeaa-8258a6b733f0', description='id of the instance')
    ...
    state = fields.String(required=True, example='available', description='state of the instance', data_key='state')
    stateReason = fields.Nested(LoggingInstanceStateReasonResponseSchema, many=False, required=True,
...
class DescribeLoggingInstances1ResponseSchema(Schema):
    ...
    nvl_instanceTotal = fields.Integer(required=False, example='0', descriptiom='total logging instance',
                                       data_key='nvl-instanceTotal')


class DescribeLoggingInstancesResponseSchema(Schema):
    DescribeLoggingInstancesResponse = fields.Nested(DescribeLoggingInstances1ResponseSchema, required=True, many=False,
                                                     allow_none=False)
...
class DescribeLoggingInstancesRequestSchema(Schema):
    ...
    instance_id_N = fields.List(fields.String(), required=False, allow_none=True, context='query',
                                collection_format='multi', data_key='instance-id.N',
...
class EnableLogConfigApiResponseSchema(Schema):
    EnableLogConfigResponse = fields.Nested(EnableLogConfigApi1ResponseSchema, required=True, many=False, allow_none=False)
...
class EnableLogConfig(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        202: {
            'description': 'success',
            'schema': EnableLogConfigApiResponseSchema
        }
    })
...
class DisableLogConfigApiResponseSchema(Schema):
    DisableLogConfigResponse = fields.Nested(DisableLogConfigApi1ResponseSchema, required=True, many=False,
                                             allow_none=False)
...
class DisableLogConfig(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        202: {
            'description': 'success',
            'schema': DisableLogConfigApiResponseSchema
        }
    })
...
class DescribeLoggingInstanceLogConfigApiV2ResponseSchema(Schema):
    DescribeLoggingInstanceLogConfigResponse = fields.Nested(DescribeLoggingInstanceLogConfigApi1V2ResponseSchema,
...
class LoggingInstanceServiceAPI(ApiView):
    ...
    def register_api(module, rules=None, **kwargs):
        ...
        rules = [
            ...
            ('%s/instance/deleteteinstance' % base, 'DELETE', DeleteLoggingInstance, {}),
            ('%s/instance/describeinstances' % base, 'GET', DescribeLoggingInstances, {}),

            ('%s/instance/describelogconfig' % base, 'GET', DescribeLoggingInstanceLogConfig, {}),
