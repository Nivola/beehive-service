...
from beehive.common.apimanager import ApiManagerError, SwaggerApiView, GetApiObjectRequestSchema, PaginatedRequestQuerySchema, ApiView, \
    ApiManagerWarning
from beehive_service.plugins.loggingservice.controller import ApiLoggingService, ApiLoggingSpace
...
class CreateSpaceApiParamRequestSchema(Schema):
    ...
    definition = fields.String(required=False, example='logging.space.xxx',
...
class CreateSpaceApiResponse1Schema(Schema):
    ...
    spaceId = fields.String(required=True, example='29647df5-5228-46d0-a2a9-09ac9d84c099', description='space id')
...
class CreateSpaceApiResponseSchema(Schema):
    CreateSpaceResponse = fields.Nested(CreateSpaceApiResponse1Schema, required=True, many=False,
                                        allow_none=False)
...
class CreateSpace(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': CreateSpaceApiResponseSchema
        }
    })
...
class DeleteSpaceApiRequestSchema(Schema):
    SpaceId = fields.String(required=False, example='29647df5-5228-46d0-a2a9-09ac9d84c099', description='space id',
                            context='query')
...
class DeleteSpaceApiResponseSchema(Schema):
    DeleteSpaceResponse = fields.Nested(DeleteSpaceApiResponse1Schema, required=True, many=False,
                                        allow_none=False)
...
class DeleteSpace(ServiceApiView):
    ...
    responses = ServiceApiView.setResponses({
        202: {
            ...
            'schema': DeleteSpaceApiResponseSchema
        }
    })
...
class LoggingSpaceDashboardResponseSchema(Schema):
    ...
    endpoint = fields.String(required=True, description='space dashboard endpoint',
                             example='https://localhost/s/prova/app/dashboards#/view/dusnawiu7cnsdiu')


class LoggingSpaceItemParameterResponseSchema(Schema):
    id = fields.String(required=True, example='075df680-2560-421c-aeaa-8258a6b733f0', description='id of the space')
    ...
    state = fields.String(required=True, example='available', description='state of the space', data_key='state')
    stateReason = fields.Nested(LoggingSpaceStateReasonResponseSchema, many=False, required=True,
...
class DescribeLoggingSpaces1ResponseSchema(Schema):
    ...
    spaceInfo = fields.Nested(LoggingSpaceItemParameterResponseSchema, many=True, required=False,
                              allow_none=True)
    spaceTotal = fields.Integer(required=False, example='0', descriptiom='total logging instance',
                                data_key='spaceTotal')
...
class DescribeSpacesRequestSchema(Schema):
    ...
    space_id_N = fields.List(fields.String(), required=False, allow_none=True, context='query',
                             collection_format='multi', data_key='space-id.N',
...
class DescribeSpaces(ServiceApiView):
    ...
    responses = ServiceApiView.setResponses({
        200: {
            'description': 'success',
            'schema': DescribeSpacesResponseSchema
        }
    })
...
class SyncUsersSpaceApiResponseSchema(Schema):
    SyncSpaceUsersResponse = fields.Nested(SyncUsersSpaceApi1ResponseSchema, required=True, many=False, allow_none=False)
...
class SyncUsersSpace(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        202: {
            'description': 'success',
            'schema': SyncUsersSpaceApiResponseSchema
        }
    })
