...
from beehive.common.apimanager import ApiObjectResponseDateSchema, ApiView, PaginatedRequestQuerySchema, \
    PaginatedResponseSchema, CrudApiObjectResponseSchema, GetApiObjectRequestSchema, \
    ApiObjectPermsResponseSchema, ApiObjectPermsRequestSchema, ApiObjectResponseSchema, \
...
from beehive_service.views.service_definition import GetServiceDefinitionParamsResponseSchema


class ListCatalogRequestSchema(ApiServiceObjectRequestSchema, ApiObjectRequestFiltersSchema,
...
class ListCatalog(ServiceApiView):
    ...
    responses = ServiceApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ListCatalogResponseSchema
        }
    })
...
class GetCatalogDefsRequestSchema(PaginatedRequestQuerySchema):
    oid = fields.String(required=True, description='id, uuid or name. If value is "all" select definitions for all the'
                                                   'catalogs you can view', context='path')
...
class GetCatalogDefs(ServiceApiView):
    ...
    responses = ServiceApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetCatalogDefsResponseSchema
        }
    })
...
class CreateCatalogDefs(ServiceApiView):
    ...
    responses = ServiceApiView.setResponses({
        200: {
            'description': 'success',
            'schema': CrudApiObjectListResponseSchema
        }
    })
...
class GetCatalogRoles(ServiceApiView):
    ...
    responses = ServiceApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetCatalogRolesResponseSchema
        }
    })
...
class GetCatalogUsers(ServiceApiView):
    ...
    responses = ServiceApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetCatalogUsersResponseSchema
        }
    })
...
class GetCatalogGroups(ServiceApiView):
    ...
    responses = ServiceApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetCatalogGroupsResponseSchema
        }
    })
