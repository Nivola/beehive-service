...
from beehive.common.apimanager import PaginatedRequestQuerySchema, \
    ...
    SwaggerApiView, ApiView, AuditResponseSchema
...
class GetConsumeResponseSchema(Schema):
    consume = fields.Nested(GetConsumeParamsResponseSchema,
...
class GetConsume(ServiceApiView):
    ...
    responses = ServiceApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetConsumeResponseSchema
        }
    })
...
class ListConsumeRequestSchema(PaginatedRequestQuerySchema, ApiObjectRequestFiltersSchema):
    ...
    field = fields.String(validate=OneOf(['id', 'metric_type_id', 'evaluation_date', 'period', 'cost_type_id'],
                                         error='Field can be id, metric_type_id, evaluation_date, period, '
                                               'cost_type_id'),
...
class ListConsume(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ListConsumeResponseSchema
        }
    })
...
class CreateConsume(ServiceApiView):
    ...
    responses = ServiceApiView.setResponses({
        201: {
            'description': 'success',
            'schema': CreateConsumeResponseSchema
        }
    })
...
class DeleteBatchConsumeRequestSchema(Schema):
    consume = fields.Nested(DeleteBatchConsumeParamRequestSchema,
                            context='body')
...
class DeleteBatchConsume(ServiceApiView):
    ...
    #     parameters = SwaggerHelper().get_parameters(DeleteBatchConsumeRequestSchema)
...
class GenerateConsume(ServiceApiView):
    ...
    responses = ServiceApiView.setResponses({
        201: {
            'description': 'success',
            'schema': GenerateConsumeResponseSchema
        }
    })
    ...
    def post(self, controller, data, *args, **kwargs):
        ...
        task, code = prepare_or_run_task(dummy, 'beehive_service.task_v2.metrics.generate_daily_consumes_task',
                                         params, sync=False)
...
class GetConsumeExtResponseSchema(Schema):
    metric_consume = fields.Nested(GetConsumeExtParamsResponseSchema,
                                   required=True, allow_none=True)
...
class GetConsumeExt(ServiceApiView):
    ...
    responses = ServiceApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetConsumeExtResponseSchema
        }
    })
...
class ListConsumeExtRequestSchema(PaginatedRequestQuerySchema):
    ...
    field = fields.String(validate=OneOf(['id', 'metric_type_name', 'extraction_date', 'metric_num',
                                          'instance_parent_id', 'instance_id'],
                                         error='Field can be id, metric_type_name, extraction_date, metric_num, instance_parent_id, '
                                               'instance_id'),
...
class ListConsumeExt(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ListConsumeExtResponseSchema
        }
    })
