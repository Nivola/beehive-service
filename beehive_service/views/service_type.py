...
class GetServiceType(ServiceApiView):
    ...
    responses = ServiceApiView.setResponses({200: {"description": "success", "schema": GetServiceTypeResponseSchema}})
...
class ListServiceTypeRequestSchema(
    ApiServiceObjectRequestSchema,
    ApiObjectRequestFiltersSchema,
    PaginatedRequestQuerySchema,
):
...
class ListServiceType(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": ListServiceTypeResponseSchema}})
...
class ListServicePluginType(ServiceApiView):
    ...
    tags = ["service"]
    definitions = {"ListServicePluginTypeResponseSchema": ListServicePluginTypeResponseSchema}
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": ListServicePluginTypeResponseSchema}}
    )
