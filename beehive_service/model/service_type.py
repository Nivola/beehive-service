...
class ServiceType(ApiBusinessObject, Base):
    ...
    plugintype: ServicePluginType = relationship(
        "ServicePluginType",
        primaryjoin="and_(ServiceType.objclass==ServicePluginType.objclass)",
    )
    ...
    objclass: str = Column(String(200), ForeignKey("service_plugin_type.objclass"), nullable=True)
