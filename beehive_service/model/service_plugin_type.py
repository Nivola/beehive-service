...
class ServicePluginType(Base):
    ...
    metric_types = relationship("ServiceMetricType", lazy='dynamic',
    ...
    def __init__(self, id, name_type, objclass, category=None, service_category: str= ServiceCategory.todo):
        self.id = id
    ...
    def __repr__(self):
        return '<%s id=%s, type=%s, objclass=%s>' % (self.__class__.__name__, self.id, self.name_type, self.objclass)