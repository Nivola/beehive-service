...
class Division(ApiBusinessObject, Base):
    ...
    organization_id = Column("fk_organization_id", Integer(), ForeignKey("organization.id"), nullable=False)
    organization = relationship("Organization", back_populates="divisions")  # ,lazy='dynamic')
